...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[self.viewController.glViewController setScriptBinding:[[[BindingTest1 alloc] init] autorelease] name:@"test1" iOSOnly:NO];
	[self.viewController.glViewController setScriptBinding:[[[BindingTest2 alloc] init] autorelease] name:@"test2" iOSOnly:NO];
	[self.viewController.glViewController setScriptBinding:[[[BindingTest3 alloc] init] autorelease] name:@"test3" iOSOnly:YES];	
	
	self.window.rootViewController = self.viewController;
	[self.window makeKeyAndVisible];
	
	[self.viewController presentGLViewControllerWithScriptFile:@"binding_test.js"];
	return YES;
}
